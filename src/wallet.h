...
static const CAmount nHighTransactionMaxFeeWarning = 1000000 * nHighTransactionFeeWarning;
...
static
void
ReadOrderPos(int64_t& nOrderPos, mapValue_t& mapValue)
{
    if (!mapValue.count("n"))
    {
...
static
void
WriteOrderPos(const int64_t& nOrderPos, mapValue_t& mapValue)
{
    if (nOrderPos == -1)
        return;
