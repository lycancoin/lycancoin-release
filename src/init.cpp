...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: lycancoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 58862 or testnet: 45884)") + "\n";
    ...
    strUsage += "  -mintxfee=<amt>        " + strprintf(_("Fees (in LYC/Kb) smaller than this are considered zero fee for transaction creation (default: %s)"), FormatMoney(CTransaction::minTxFee.GetFeePerK())) + "\n";
    strUsage += "  -minrelaytxfee=<amt>   " + strprintf(_("Fees (in LYC/Kb) smaller than this are considered zero fee for relaying (default: %s)"), FormatMoney(CTransaction::minRelayTxFee.GetFeePerK())) + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 58861 or testnet: 48862)") + "\n";
