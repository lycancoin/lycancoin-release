...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lycancoin Core lycancoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lycancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lycancoin transaction") + "\n" +
              "  lycancoin-tx [options] -create [commands]   " + _("Create hex-encoded lycancoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lycancoin transaction
