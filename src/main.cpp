...
//static CBigNum bnProofOfWorkLimit(~arith_uint256(0) >> 20); //Necessary for KGW
...
{
    CAmount nSubsidy = 2970 * COIN; //Starting coins per block
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Reject block.nVersion=1 blocks when 95% last 30 days (17,280 blocks) (75% on testnet) of the network has upgraded:
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // if 12960 of the last 17,280 blocks are version 2 or greater (51/100 if testnet):
