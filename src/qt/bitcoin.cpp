...
{
    return QCoreApplication::translate("lycancoin-core", psz).toStdString();
}
...
/** Class encapsulating Lycancoin Core startup and shutdown.
...
/** Main Lycancoin application object */
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if(retval)
    {
        ...
        // Lycancoin: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Lycancoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Lycancoin");
    QApplication::setOrganizationDomain("Lycancoin.org");
    if (isaTestNet) // Separate UI settings for testnets
        QApplication::setApplicationName("Lycancoin-Qt-testnet");
    else
        QApplication::setApplicationName("Lycancoin-Qt");
    ...
    if (fSelParFromCLFailed) {
        QMessageBox::critical(0, QObject::tr("Lycancoin"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
    ...
    /// 6. Determine availability of data directory and parse Lycancoin.conf
    ...
    // Lycancoin: links repeatedly have their payment requests routed to this process:
