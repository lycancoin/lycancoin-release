    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Lycancoin address (e.g. 1NS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        else if (!addr.IsValid()) // Invalid address
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Lycancoin address"));
        }
        else // Valid address
        {
            CPubKey pubkey;
